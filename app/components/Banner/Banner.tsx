...
const Banner = () => {
  ...
  return (
    ...
    //         <a href="#" className="inline-flex items-center ml-2 text-sm font-medium text-blue-600 md:ml-2 dark:text-blue-500 hover:underline">
    //           Check it out
    ...
    //         <button data-dismiss-target="#marketing-banner" type="button" onClick={handleCloseBanner} className="shrink-0 inline-flex justify-center w-7 h-7 items-center text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 dark:hover:bg-gray-600 dark:hover:text-white">
