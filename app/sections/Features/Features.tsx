        ...
        <Section id="services" className="bg-gray-50 dark:bg-gray-800">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Data Science & Fullstack Development Tools</h2>
                    <p className="text-gray-500 sm:text-xl dark:text-gray-400">Explore a comprehensive set of tools essential for fullstack development and data science.</p>
                </div>
