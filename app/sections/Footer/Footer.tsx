        ...
        <div className="container mx-auto">
            <div className="flex flex-wrap justify-between py-10">
                ...
                <div className="my-8 w-full text-center sm:w-1/2 md:mb-0 md:text-left lg:w-1/3">
                    ...
                    <ul className="flex justify-center space-x-4">
                        ...
                        <Link href="https://www.facebook.com/share/1BCXNwVcDh/?mibextid=wwXIfr" className="rounded-full text-gray-400 hover:text-white" aria-label="Facebook">
                            <svg className="size-6  text-blue-700 dark:text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <Link href="#" className="rounded-full text-gray-400 hover:text-white">
                            <svg className="size-6  text-blue-700 dark:text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div className="my-8 w-full px-8 text-center sm:w-1/2 md:mb-0 md:text-left lg:w-1/3">
                    <div>
                        <h6 className="text-lg font-bold  text-blue-700 dark:text-yellow-300">Contact us</h6>
                        <hr className="mt-4  border-gray-200"/>
                    </div>
                    <ul className="mt-4 space-y-2 text-left">
                        <li className="flex items-center">
                            <svg className="mr-2 size-5 shrink-0  text-blue-700 dark:text-yellow-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="my-8 w-full px-8 text-center md:text-left lg:w-1/3">
                    <div>
                    <h6 className="text-lg font-bold  text-blue-700 dark:text-yellow-300">Newsletter</h6>
                    <hr className="mt-4 border-gray-200"/>
                    </div>
