...
const Newsletter = () => {
  return (
    <div className="px-4 mx-auto max-w-screen-xl lg:px-6 bg-white dark:bg-gray-800">
        <div className="mx-auto max-w-screen-md sm:text-center">
            <p className="mb-8 font-light text-gray-500 md:mb-12 sm:text-base dark:text-gray-400">Stay up to date with the roadmap progress, announcements and exclusive discounts feel free to sign up with your email.</p>
            <form action="#">
